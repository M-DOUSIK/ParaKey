...
# Generated on: Wed Nov 05 13:20:49 IST 2025 (Wed Nov 05 07:50:49 UTC 2025)
...
set logfile fv/KeyPadInterpreter/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/KeyPadInterpreter -revised fv_map
...
add_search_path /home/install/FOUNDRY/digital/45nm/LIBS/lib/max -library -both
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../../Default/Source/KeyPadInterpreter.v
elaborate_design -golden -root {KeyPadInterpreter} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/KeyPadInterpreter/fv_map.v.gz
elaborate_design -revised -root {KeyPadInterpreter}
...
add_black_box PulseCounter KeyPadDecoder LFSR25000 KeyPadScanner -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.KeyPadInterpreter.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.KeyPadInterpreter.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.KeyPadInterpreter.rtl.fv_map.rpt
